...
public class NotificationAboutMaterialAchievement implements Serializable {

    private static final long serialVersionUID = 1339601569;

    private ULong notificationId;
    private ULong reasonId;

    public NotificationAboutMaterialAchievement() {
    }

    public NotificationAboutMaterialAchievement(NotificationAboutMaterialAchievement value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("NotificationAboutMaterialAchievement (");
