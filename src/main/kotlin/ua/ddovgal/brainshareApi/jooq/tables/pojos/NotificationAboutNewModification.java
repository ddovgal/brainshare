...
public class NotificationAboutNewModification implements Serializable {

    private static final long serialVersionUID = 2072173945;

    private ULong notificationId;
    private ULong reasonId;

    public NotificationAboutNewModification() {
    }

    public NotificationAboutNewModification(NotificationAboutNewModification value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("NotificationAboutNewModification (");
