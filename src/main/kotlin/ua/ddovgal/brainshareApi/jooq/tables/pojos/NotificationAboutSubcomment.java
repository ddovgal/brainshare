...
public class NotificationAboutSubcomment implements Serializable {

    private static final long serialVersionUID = 1972003351;

    private ULong notificationId;
    private ULong reasonId;

    public NotificationAboutSubcomment() {
    }

    public NotificationAboutSubcomment(NotificationAboutSubcomment value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("NotificationAboutSubcomment (");
